...
router.get('/',
  [
    ...
    query('accountableLocationId').optional().isInt().withMessage('Must be integer'),
...
router.post('/',
  [
    ...
    body('accountableLocationId').optional({ nullable: true }).isInt().withMessage('Must be integer'),
