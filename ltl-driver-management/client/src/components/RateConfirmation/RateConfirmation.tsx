            ...
            <div className="p-1">
              <div className="grid grid-cols-2 gap-1">
                <div>
                  ...
                  <div className="text-xs"><span className="font-bold">Address:</span> {getLocationData(childBooking.route?.origin)?.address || childBooking.route?.originAddress || childBooking.originAddress || '985 Glendale Avenue'}</div>
                  <div className="text-xs"><span className="font-bold">City, State Zip:</span> {getLocationData(childBooking.route?.origin)?.city || childBooking.route?.originCity || childBooking.originCity || 'SPARKS'}, {getLocationData(childBooking.route?.origin)?.state || childBooking.route?.originState || childBooking.originState || 'NV'} {getLocationData(childBooking.route?.origin)?.zipCode || childBooking.route?.originZipCode || childBooking.originZipCode || '89431'}</div>
                  <div className="text-xs"><span className="font-bold">Phone:</span> {getLocationData(childBooking.route?.origin)?.phone || '(775) 331-2311'} <span className="font-bold">Contact:</span> {getLocationData(childBooking.route?.origin)?.contact || childBooking.route?.originContact || childBooking.originContact || 'Brian Smith'}</div>
                ...
                <div>
                  ...
                  <div className="text-xs"><span className="font-bold">Address:</span> {getLocationData(childBooking.route?.destination)?.address || childBooking.route?.destinationAddress || childBooking.destinationAddress || '2800 S El Dorado ST'}</div>
                  <div className="text-xs"><span className="font-bold">City, State Zip:</span> {getLocationData(childBooking.route?.destination)?.city || childBooking.route?.destinationCity || childBooking.destinationCity || 'STOCKTON'}, {getLocationData(childBooking.route?.destination)?.state || childBooking.route?.destinationState || childBooking.destinationState || 'CA'} {getLocationData(childBooking.route?.destination)?.zipCode || childBooking.route?.destinationZipCode || childBooking.destinationZipCode || '95206'}</div>
                  <div className="text-xs"><span className="font-bold">Phone:</span> {getLocationData(childBooking.route?.destination)?.phone || ''} <span className="font-bold">Contact:</span> {getLocationData(childBooking.route?.destination)?.contact || childBooking.route?.destinationContact || childBooking.destinationContact || ''}</div>
                </div>
              </div>
            </div>
          </div>
