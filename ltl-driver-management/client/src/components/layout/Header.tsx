...
import { Menu, User, LogOut, Building2, Sun, Moon } from 'lucide-react';
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors"
            ...
            <div className="flex items-center text-sm text-gray-700 dark:text-gray-200">
              ...
              <span className="ml-2 text-gray-500 dark:text-gray-400">({user?.role})</span>
            </div>
